...
- **Hello, install:multi!** How to install executable on local with "Ninja Multi-Config" "basic_140" <br/> [Youtube Video](https://youtu.be/tCN-eFZN8xE) | ... | [Code](https://github.com/cnruby/w3h1_cmake/tree/basic_140)
